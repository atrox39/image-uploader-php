...
$result = $link->query('SELECT images.id, users.username, images.name, images.original FROM images INNER JOIN users ON images.userid = users.id ORDER BY images.id DESC');
$images = array();
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="/images.php">Images<span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
